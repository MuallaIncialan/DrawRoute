package com.example.mualla.drawroute;
...
//                lineOptions2 = new PolylineOptions();
                LatLng position = new LatLng(latitude2, longitude2);
//                points2.add(position);
//                lineOptions2.addAll(points2);
//                lineOptions2.width(6);
//                lineOptions2.color(Color.RED);
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            for (int i = 0; i < result.size(); i++) {
                ...
                lineOptions.width(6);
                lineOptions.color(Color.rgb(65,149,255));
